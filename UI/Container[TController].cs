...
{
    /// <summary>
    /// Counterpart to the <see cref="View{TPresenter}"/> for <see cref="Container"/>s.
    /// </summary>
    /// <remarks>
    /// https://github.com/blish-hud/Blish-HUD/blob/dev/Blish%20HUD/GameServices/Graphics/UI/View%5BTPresenter%5D.cs
    /// </remarks>
    public abstract class Container<TController> : Container where TController : IController
    {
        ...
        public Container<TController> WithController(TController controller)
        {
            if (controller == null)
            {
