...
{
    //public abstract class ModuleContextProvider<TModuleContext> : IDisposable where TModuleContext : Context
    //{
    ...
    //    private TModuleContext _context;
    ...
    //    /// <summary>
    //    /// The <see cref="IntegrationState"/> of the <see cref="ModuleContextProvider{TModuleContext}"/>.
    //    /// </summary>
    ...
    //    /// <summary>
    //    /// The context, that the <see cref="ModuleContextProvider{TModuleContext}"/> provides. Will be null, if 
    //    /// the <see cref="State"/> != <see cref="IntegrationState.Working"/>.
    //    /// </summary>
    //    public TModuleContext Context
    //    {
    //        get
    //        {
    ...
    //    {
    //        _context = GameService.Contexts.GetContext<TModuleContext>();
    ...
    //    public ModuleContextProvider(ModuleService moduleService, string moduleNamspace)
    //    {
    ...
    public abstract class ModuleContextProvider : IDisposable
    {
        private IntegrationState _state;
