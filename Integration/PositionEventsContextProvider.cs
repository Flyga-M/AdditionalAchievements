...
{
    //public class PositionEventsContextProvider : ModuleContextProvider<PositionEventsContext>
    public class PositionEventsContextProvider : ModuleContextProvider
    {
